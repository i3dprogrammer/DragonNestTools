...
namespace DragonNestTools
{
    class Program
    {
        ...
        {
            var pak = new PakFile(@"F:\Dragon Nest MuSh0 Version\Extracted PAK files\Resource16\Resource17.pak");
            ...
            //pak.Files.ForEach(x =>
            //{
            //    FileInfo info = new FileInfo(@"F:\Dragon Nest MuSh0 Version\Extracted PAK files\Resource16" + x.Path);
